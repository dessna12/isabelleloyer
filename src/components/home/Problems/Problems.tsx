...
const symptoms = [
  <><em>Vous vous sentez prisonnier·ère d'une relation qui vous détruit </em><br /> Vous doutez de vos propres perceptions, vous vivez dans la confusion ou vous avez le sentiment de vous être "effacé·e" face à une personne manipulatrice ou dénigrante.</>,
  <><em>Vous portez un sentiment d'illégitimité qui vient de loin  </em><br /> Vous avez grandi dans un climat insécurisant ou sans limites claires. Aujourd'hui, cela se traduit par un manque de confiance profond, une peur d'être abandonné·e ou le sentiment de n'être jamais vraiment à votre place. </>,
  <><em>Vous vous sentez comme "éteint·e" ou en alerte constante après une agression </em><br />  Votre corps est resté bloqué dans la peur ou la sidération après avoir subi des violences (sexuelles, physiques ou conjugales). Vous cherchez un espace protégé pour sortir de cet état de survie, retrouver votre dignité et vous sentir à nouveau en sécurité dans votre propre corps.</>,
